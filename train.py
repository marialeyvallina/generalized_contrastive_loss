...
class TrainParser():
    def __init__(self):
        ...
        self.parser.add_argument('--pool', type=str, help='Global pool layer  max|avg|GeM')
...
def train(params):
    ...
    dataloader = create_msls_dataloader(params.dataset, params.root_dir, params.cities, transform= image_t, batch_size=params.batch_size, model=model.cuda())
